                        ...
                        <tbody>
                            {
                                [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Ibrahim Gazi </td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Easy Shop</td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                        <span>Pending</span> </td>
                                    <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>ibrahim@gmail.com </td>
